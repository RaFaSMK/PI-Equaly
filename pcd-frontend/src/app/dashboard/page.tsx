...
export default function DashboardPage() {
  ...
  const statusBadge = (s: string) => (
    <span className="rounded bg-zinc-100 dark:bg-zinc-700 px-2 py-0.5 text-xs text-zinc-800 dark:text-zinc-200">
      {s}
    </span>
  );
        ...
        <section>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            <input
              ...
              className="w-full rounded-md border border-zinc-300 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 p-2 text-sm"
            />
            <button
